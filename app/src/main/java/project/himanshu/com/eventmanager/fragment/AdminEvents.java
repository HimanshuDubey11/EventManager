            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        double fee = object.getDouble("amount");
                        ...
                        events.add(new Events(name,description,startDate,type,fee));

                        RecyclerView recyclerView = view.findViewById(R.id.admineventrecyclerview);
