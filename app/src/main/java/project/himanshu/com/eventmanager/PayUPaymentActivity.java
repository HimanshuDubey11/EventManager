...
public class PayUPaymentActivity extends Activity {
    ...
    static String getChargeAmt,getFirstName="User",getNumber="8878186782",getEmailAddress="hmnshdb10@gmail.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentSharedPref = StudentSharedPref.getInstance(PayUPaymentActivity.this);
...
/*
      ...
      //  getChargeAmt = oIntent.getExtras().getString("CHARGE_AMT");
        ...
        params.put("amount", studentSharedPref.getPay() + "");
        params.put("firstname", studentSharedPref.getName() + "");
        params.put("email", getEmailAddress);
        params.put("phone", getNumber);
        params.put("productinfo", "Pay For " + studentSharedPref.getEventName());
